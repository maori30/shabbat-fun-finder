...
const ATTRACTIONS: Attraction[] = [
  ...
  { id: 60, name: "מגדל דוד - מוזיאון", city: "ירושלים", region: "ירושלים", category: "מוזיאון", openShabbat: true, environment: "משולב", minAge: 5, maxAge: 16, description: "סיור בהיסטוריה של ירושלים.", emoji: "🏰", lat: 31.7761, lng: 35.2278, url: "https://www.tod.org.il/" },
  { id: 61, name: "קניון עזריאלי תל אביב", city: "תל אביב", region: "מרכז", category: "קניון", openShabbat: false, environment: "ממוזג", minAge: 0, maxAge: 16, description: "קניון גדול עם קולנוע, מסעדות וארקייד.", emoji: "🛍️", lat: 32.0745, lng: 34.7920, url: "https://www.azrieli.com/mall/azrieli-tel-aviv/" },
  { id: 62, name: "קניון איילון", city: "רמת גן", region: "מרכז", category: "קניון", openShabbat: false, environment: "ממוזג", minAge: 0, maxAge: 16, description: "קניון ענק עם קולנוע וסניפי בילוי לילדים.", emoji: "🛒", lat: 32.0847, lng: 34.8014, url: "https://www.ayalonmall.co.il/" },
  { id: 63, name: "קניון גרנד חיפה", city: "חיפה", region: "צפון", category: "קניון", openShabbat: true, environment: "ממוזג", minAge: 0, maxAge: 16, description: "קניון פתוח בשבת עם קולנוע ומסעדות.", emoji: "🏬", lat: 32.7940, lng: 35.0350, url: "https://www.grandkanyon.co.il/" },
  { id: 64, name: "קניון הזהב ראשל\"צ", city: "ראשון לציון", region: "מרכז", category: "קניון", openShabbat: true, environment: "ממוזג", minAge: 0, maxAge: 16, description: "קניון פתוח בשבת עם ארקייד וקולנוע.", emoji: "🛍️", lat: 31.9930, lng: 34.7750, url: "https://www.hazahav.co.il/" },
  { id: 65, name: "ביג פאשן אשדוד", city: "אשדוד", region: "דרום", category: "קניון", openShabbat: true, environment: "ממוזג", minAge: 0, maxAge: 16, description: "מרכז קניות פתוח בשבת עם מתחם בילוי.", emoji: "🏬", lat: 31.7920, lng: 34.6510, url: "https://big.co.il/" },
  { id: 66, name: "סינמה סיטי גלילות", city: "רמת השרון", region: "מרכז", category: "קולנוע", openShabbat: true, environment: "ממוזג", minAge: 4, maxAge: 16, description: "מתחם קולנוע ענק עם ארקייד ובילוי משפחתי.", emoji: "🎬", lat: 32.1585, lng: 34.8060, url: "https://www.cinema-city.co.il/" },
  { id: 67, name: "סינמה סיטי ראשל\"צ", city: "ראשון לציון", region: "מרכז", category: "קולנוע", openShabbat: true, environment: "ממוזג", minAge: 4, maxAge: 16, description: "קולנוע רב אולמות עם מתחם משחקים.", emoji: "🎥", lat: 31.9840, lng: 34.7810, url: "https://www.cinema-city.co.il/" },
  { id: 68, name: "יס פלאנט באר שבע", city: "באר שבע", region: "דרום", category: "קולנוע", openShabbat: true, environment: "ממוזג", minAge: 4, maxAge: 16, description: "קומפלקס קולנוע ובילוי משפחתי.", emoji: "🍿", lat: 31.2430, lng: 34.7920, url: "https://www.yesplanet.co.il/" },
  { id: 69, name: "אייס פיקס אילת", city: "אילת", region: "דרום", category: "החלקה על הקרח", openShabbat: true, environment: "ממוזג", minAge: 4, maxAge: 16, description: "מגלשת קרח והחלקה במדבר.", emoji: "⛸️", lat: 29.5560, lng: 34.9520, url: "https://www.icepark.co.il/" },
  { id: 70, name: "קניון איילון של הים - סי מול", city: "אשדוד", region: "דרום", category: "קניון", openShabbat: true, environment: "ממוזג", minAge: 0, maxAge: 16, description: "קניון בחוף אשדוד פתוח בשבת.", emoji: "🌊", lat: 31.7840, lng: 34.6350, url: "https://seamall.co.il/" },
  { id: 71, name: "מתחם TLV Fashion Mall", city: "תל אביב", region: "מרכז", category: "קניון", openShabbat: false, environment: "ממוזג", minAge: 0, maxAge: 16, description: "קניון בילוי, מסעדות וארקייד.", emoji: "🛍️", lat: 32.0568, lng: 34.7626, url: "https://www.tlv-mall.co.il/" },
  { id: 72, name: "קניון מלחה", city: "ירושלים", region: "ירושלים", category: "קניון", openShabbat: false, environment: "ממוזג", minAge: 0, maxAge: 16, description: "קניון גדול עם קולנוע וארקייד.", emoji: "🏬", lat: 31.7515, lng: 35.1876, url: "https://www.jerusalem-mall.co.il/" },
  { id: 73, name: "פאן פאן ראשל\"צ", city: "ראשון לציון", region: "מרכז", category: "משחקייה", openShabbat: true, environment: "ממוזג", minAge: 1, maxAge: 10, description: "משחקייה ענקית ומתקנים לילדים.", emoji: "🎪", lat: 31.9850, lng: 34.7830, url: "https://funfun.co.il/" },
  { id: 74, name: "אייס מול אילת", city: "אילת", region: "דרום", category: "קניון", openShabbat: true, environment: "ממוזג", minAge: 0, maxAge: 16, description: "קניון פתוח בשבת בטיילת אילת.", emoji: "🧊", lat: 29.5560, lng: 34.9530, url: "https://www.icemall.co.il/" },
  { id: 75, name: "מתחם דיזנגוף סנטר", city: "תל אביב", region: "מרכז", category: "קניון", openShabbat: true, environment: "ממוזג", minAge: 0, maxAge: 16, description: "קניון עם קולנוע, אוכל ובילוי.", emoji: "🛍️", lat: 32.0770, lng: 34.7745, url: "https://dizengof-center.co.il/" },
];
