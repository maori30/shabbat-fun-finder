          ...
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="flex flex-col gap-1">
              <button
                onClick={() => runAiSearch()}
                disabled={aiLoading}
                className="glass-btn-primary rounded-2xl px-6 py-3 text-base font-bold disabled:opacity-70 inline-flex items-center justify-center gap-2"
              >
                {aiLoading && !itineraryLoading ? "ה-AI מחפש בשבילכם..." : "✨ מצא לי פעילות מתאימה"}
              </button>
              <span className="text-xs text-muted-foreground text-center px-1">
                מציג רשימה של מקומות ספציפיים שמתאימים לבקשה שלכם
              </span>
            </div>
            <div className="flex flex-col gap-1">
              <button
                ...
                disabled={aiLoading}
                className="rounded-2xl px-6 py-3 text-base font-bold disabled:opacity-70 inline-flex items-center justify-center gap-2 bg-gradient-to-r from-purple-500 to-indigo-500 text-white hover:from-purple-600 hover:to-indigo-600 shadow-lg"
              >
                {itineraryLoading ? "בונה מסלול..." : "🎲 תבנה לי את השבת"}
              </button>
              <span className="text-xs text-muted-foreground text-center px-1">
                בונה תוכנית מלאה (בוקר וצהריים) שמתחשבת גם במזג האוויר!
              </span>
            </div>
          </div>
          {aiPrompt && (
            <div className="mt-2 text-center">
              <button
                ...
                className="glass-btn rounded-2xl px-4 py-1.5 text-xs inline-flex items-center gap-1"
              >
                ✕ נקה חיפוש
              </button>
            </div>
